...
/**
 * This sink only indexes incoming documents and does not delete records that were not part of the indexing anymore
 * 
 * @author v2
 *
 */
public class ElasticsearchSimpleDocumentSink implements DocumentSink {
	private static Logger logger = Logger.getLogger(ElasticsearchSimpleDocumentSink.class);
